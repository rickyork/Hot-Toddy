...
$.extend(
    editor, {
        ...
        setEditability : function(isEditable)
        {
            ...
            // editing is enabled.
            var buttons = this.$('div.hEditorContentEditableButtons');
    ...
    */
        ...
        */
        save : function()
        {
            ...
            this.document
                .removeClass('hEditorTemplateDocument');
            ...
            application.status.message('Saving Document...');
            ...
            if (false !== hot.fire('editorSave'))
            {
                http.post(
                    ...
                    function(json)
                    {
                        ...
                        application.status.message('Document Saved!', true);
