$.fn.extend({
    ...
    */
    ...
    toggleExpandProperty : function()
    {
        ...
        var baseProperty = tr.attr('data-property');
        ...
        tr.nextAll('tr.hEditorTemplateExpandProperty').each(
            function()
            {
                if ($(this).attr('data-base-property') == baseProperty)
                {
                    if (open)
                    {
                        $(this).show();
...
$.extend(
    editor, {
        ...
        panelReady : function()
        {
            ...
            $('ul#hEditorTemplateObjectMediaTabs li button').click(
                function(event)
                {
                    event.preventDefault();
                    $(this).parents('li:first').openSidePanel();
                }
            );

            // Open the first tab by simulating a click on it.
            $('ul#hEditorTemplateObjectMediaTabs li:first button').click();
            ...
            // Properties, etc.
            $('ul.hEditorTemplatePanelTabs li').click(
                function()
                {
                    ...
                    $('div#hEditorTemplatePanel' + name + $(this).splitId()).select('hEditorTemplatePanelPane');
                }
            );

            // This simulates a click on the first tab of the floating Editor panel.  "Format".
            $('ul.hEditorTemplatePanelTabs li:first').click();
            ...
            $('h1.hEditorTemplatePanelTitle').dblclick(
                function()
                {
                    console.log("test");
            ...
            $('img.hEditorTemplateExpandProperty').click(
                function()
                {
        ...
        */
        openModal : function()
        {
            $('div#hEditorTemplateModalDialogueJammer').fadeIn();
        },

        closeModal : function()
        {
            $('div#hEditorTemplateModalDialogueJammer').fadeOut();
        }
    }
);
