$.fn.extend({
    ...
    */
    ...
    getCaretPosition : function()
    {
        ...
        {
            node = this.parents('div.hEditorTemplateNodeWrapper:first')
    ...
    /**
    * In some situations, we might be working with a node inside of a node wrapper, rather than
    * the node wrapper itself.  In those situations, it's necessary to move up the DOM to that
    * element's node wrapper to ensure consistency.
    */
    ...
    /**
    * Relative to the presently selected node, iterate to the closest preceding node, whether that
    * node be an adjacent sibling, a parent, etc, and select it.
    *
    */
    selectPreviousNode : function()
    {
        ...
        return this.getPreviousNode(removeCaret).selectNode();
    },
    ...
    */
    getPreviousNode : function()
    {
        ...
        {
            prevNode = node.prev().find('div.hEditorTemplateNodeWrapper:last');
        }
    ...
    */
    selectNextNode : function()
    {
        ...
        return this.getNextNode(removeCaret).selectNode();
    },
...
*/
        ...
        this.children(editor.nodes).setProperties();
...
*/
        ...
        $('span#hEditorContentSelected').css(
            'backgroundColor',
...
$.extend(
    editor, {
        ...
        */
        ...
        /**
        * Don't use this, use the contextual getCaretPosition method instead (written as a jQuery
        * extension at the top of this file)
        *
        */
        getCaretPosition : function()
        {
