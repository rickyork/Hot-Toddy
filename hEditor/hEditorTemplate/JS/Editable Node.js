$.fn.extend({
    ...
    */
    wrapNode : function()
    {
        if (!this.parent('div.hEditorTemplateNodeWrapper').length)
        {
            ...
            {
                var html =
                    "<video src='" + this.attr('title') + "'" +
                          " poster='" + this.attr('src') + "'" +
                          " controls='controls'" +
                          " data-file-path='" + this.attr('title') + "'" +
                          " style='" + this.attr('style') + "'></video>";
    ...
    */
    unwrapNode : function()
    {
         ...
         this.children('ul.hEditorTemplateNodeControls, div.hEditorTemplateNodeControl').remove();
