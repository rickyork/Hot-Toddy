...
editor.image = {
    ...
    openFinder : function()
    {
        // Open a Finder Choose dialogue so that the user may select an image from
        // the file system.
    ...
    {
        // When the "Remove" button is pressed, delete the img node from the DOM.
    ...
    getNode : function()
    {
        ...
        else
        {
            ...
            {
                // If no img node is set, look at the node residing where the text caret
                // presently resides.  If that node is an img node, set that to be the img
            ...
            {
                // As a last resort, simply create a new img node and return the new one.
    ...
    save : function(obj)
    {
        ...
        // If there is a selection, replace it with the img node.  If there is just
        // a caret position, insert the node at that position.
