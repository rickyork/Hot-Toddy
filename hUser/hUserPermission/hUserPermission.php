...
class hUserPermission extends hPlugin {
    ...
    public function hConstructor()
    {
        ...
        #$this->hTemplatePath = '/hUser/hUserPermission/hUserPermission.template.php';
    ...
    private function save()
    {
        if (isset($_POST['hUserPermissionsForm']))
        {
            ...
            $this->hUserPermission->setGroups($userGroups);
    ...
    {        
        ...
        $permissions = $this->hUserPermission->getPermissions(
            $this->hFrameworkResourceId,
            $this->hFrameworkResourceKey
        );
